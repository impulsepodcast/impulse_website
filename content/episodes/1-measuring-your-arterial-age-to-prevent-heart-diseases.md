---
number: 1
title: Measuring your arterial age to prevent heart diseases
guest: Ted Baldwin
company: Imageens
releasedAt: 2022-02-22
image: /static/images/episodes/1-measuring-your-arterial-age-to-prevent-heart-diseases.webp
...
links:
  spotify: https://open.spotify.com/episode/4xT3vkTaOMGRIHEBgDY491?si=7d4ee5bb0ced44c3&nd=1&dlsi=0794b85ba1704820
...
This is the challenge that [Imageens](https://www.imageens.com/), a Paris-based medical technology startup led by [Ted Baldwin](https://www.linkedin.com/in/ted-baldwin/), is tackling through the application of artificial intelligence to medical imaging technology, with the aim to quantify your arterial age.

This specific biomarker unvails unique opportunities to anticipate heart conditions for people at moderate risk, with the promise to inform better clinical care decisions.

In this episode of Impulse, we exchanged with Ted on the burden that cardiovascular diseases represent on a global level, the power of AI applied to medical imaging to discover early indicators of these pathologies, and how these insights can drive better personalized prevention programs to stay away from them.

What we also talked with Ted about:
- [Assistance Publique - Hôpitaux de Paris](https://www.aphp.fr/) (AP-HP)
- [MESA trial](https://www.mesa-nhlbi.org/)
- Framingham risk score
- Cardiac CT calcium score
- Ascending aortic distensibility
- [Ted’s TEDx presentation](https://www.youtube.com/watch?v=QGGJoBDW36A)
- [Ganymed Robotics](https://www.ganymedrobotics.com/)
- [Zoï](https://www.zoi.com/)
- [Altos Labs](https://altoslabs.com/)
- [Qualitiso](https://www.qualitiso.com/)

If you want to know more about Imageens, we invite you to consult their [website](https://www.imageens.com/).

You can contact Ted through [LinkedIn](https://www.linkedin.com/in/ted-baldwin/) or by email: [tbaldwin@imageens.com](mailto:tbaldwin@imageens.com)

If you want to give me feedback on the episode, ask questions or suggest potential guests, feel free to do so through [LinkedIn](https://www.linkedin.com/in/mathieu-chaffard/) or by email: [m.chaffard05@gmail.com](mailto:m.chaffard05@gmail.com)
