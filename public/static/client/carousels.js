function initializeCarousel(root) {
    ...
    function currentPage() {
        return Math.min(pageCount(), Math.max(1, Math.round(safeViewport.scrollLeft / Math.max(safeViewport.clientWidth, 1)) + 1));
    }
...
for (const carousel of Array.from(document.querySelectorAll("[data-carousel]"))) {
