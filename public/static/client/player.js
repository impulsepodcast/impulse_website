...
function initializeStickyPlayer() {
    ...
    const audio = root?.querySelector("[data-sticky-player-audio]");
    if (!root || !audio) {
        return;
    }
    const playerRoot = root;
    const playerAudio = audio;
    const playButton = playerRoot.querySelector("[data-sticky-player-play]");
    const backButton = playerRoot.querySelector("[data-sticky-player-back]");
    const forwardButton = playerRoot.querySelector("[data-sticky-player-forward]");
    const muteButton = playerRoot.querySelector("[data-sticky-player-mute]");
    const menuButton = playerRoot.querySelector("[data-sticky-player-menu]");
    const progressTrack = playerRoot.querySelector(".sticky-player__progress");
    const progressFill = playerRoot.querySelector("[data-sticky-player-progress-fill]");
    ...
    for (const platformLink of Array.from(playerRoot.querySelectorAll(".sticky-player__platforms a"))) {
